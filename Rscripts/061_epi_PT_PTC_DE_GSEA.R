# Continued from 021_clustering_epi_PT_PTC.R
analysis_step <- "061_epi_PT_PTC_DE"
...
# Load data ----
seu <- readRDS(file.path("RDSfiles", "seu_021_epi_PT_PTC.RDS"))
...
seu$de_group <- ""
seu$de_group[seu$celltype_2 == "PTC3"] <- "test" 
seu$de_group[seu$celltype_2 %in% c("PTC1", "PTC2")] <- "ref"
