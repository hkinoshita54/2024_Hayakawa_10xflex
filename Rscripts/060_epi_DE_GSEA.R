...
# DE, PTC_Epi-PTC vs Prog., Pit and Neck ----
## set groups for DE analysis
seu$de_group <- ""
seu$de_group[seu$gt_ct == "PTC_Epi-PTC"] <- "test" 
seu$de_group[seu$celltype %in% c("Prog.", "Pit", "Neck")] <- "ref"

## Wilcoxauc test
res <- presto::wilcoxauc(X = seu[["RNA"]]$data, y = seu$de_group, groups_use = c("test", "ref"))
res <- res %>% filter(group == "test" & (pct_in != 0 | pct_out != 0))

test_group <- "PTC_Epi-PTC"
ref_group <- "Prog_Pit_Neck"
...
# DE, PTC_Epi-PTC vs PC_Epi-PC ----
## set groups for DE analysis
seu$de_group <- ""
seu$de_group[seu$gt_ct == "PTC_Epi-PTC"] <- "test" 
seu$de_group[seu$gt_ct == "PC_Epi-PC"] <- "ref"
...
# DE, PC_Epi-PC vs Prog., Pit and Neck ----
## set groups for DE analysis
seu$de_group <- ""
seu$de_group[seu$gt_ct == "PC_Epi-PC"] <- "test" 
seu$de_group[seu$celltype %in% c("Prog.", "Pit", "Neck")] <- "ref"
