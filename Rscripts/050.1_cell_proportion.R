# Continued from 010.1_clustering_2.R etc.
# Without integration
analysis_step <- "050.1_cell_proportion"
...
# Set palette 
pal <- DiscretePalette(36, palette = "polychrome")

# All ----
fraction <- "all"

## merge 3 fractions
seu_epi <- readRDS(file.path("RDSfiles", "seu_020.1_epi.RDS"))
seu_imm <- readRDS(file.path("RDSfiles", "seu_030.1_imm.RDS"))
seu_str <- readRDS(file.path("RDSfiles", "seu_040.1_str.RDS"))
