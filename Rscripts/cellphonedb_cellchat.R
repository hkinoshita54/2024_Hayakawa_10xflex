...
interaction_input <- read.csv(file = "aux_data/cellphonedbv5/v5.0.0_interaction_input.csv")
complex_input <- read.csv(file = "aux_data/cellphonedbv5/v5.0.0_complex_input.csv", row.names = 1)
geneInfo <- read.csv(file = "aux_data/cellphonedbv5/v5.0.0_gene_input.csv")
