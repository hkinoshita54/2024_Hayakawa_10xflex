# modify cellchat db
# use only Bmpr1a as bmp receptor (for test)
analysis_step <- "300.2_cellchatdb_modification_2"
...
# add to cellchatdb ----
CellChatDB.new2 <- CellChat::updateCellChatDB(
  db             = newLR,
  merged         = TRUE,
  species_target = "mouse"
)

save(CellChatDB.new2, file = "RDSfiles/CellChatDB.new2.RData")
